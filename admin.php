...
$sql = "UPDATE `users` SET PhoneNo = '".$PhoneNo."', Address = '".$Address."', NationalID = '".$NatId."', email = '".$email."'   WHERE users.Name = '".$Name."'";
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="index.html">WELCOME <?php echo $Name?></a>
...
<hr>
  <form class="form" action="admin.php" method="post" id="Edit" enctype="multipart/form-data">
      ...
      <div class="form-group">
          ...
          <div class="col-xs-6">
              ...
              <input readonly type="text" class="form-control" name="NatID" id="email" placeholder="you@email.com" value="<?php echo $NationalID?>">
          </div>
      </div>
